...
{
    public partial class SlackifyLightStyleDetailRibbonForm : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IBarManagerHolder, ISupportViewChanged, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder
    {
        ...
        public SlackifyLightStyleDetailRibbonForm()
        {
            InitializeComponent();
