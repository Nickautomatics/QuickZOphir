...
{
    [ToolboxItem(false)]
    public partial class SlackifyNestedFrameTemplate : XtraUserControl, IActionControlsSite, IFrameTemplate, ISupportActionsToolbarVisibility, IViewSiteTemplate, ISupportUpdate, IBarManagerHolder, ISupportViewChanged, IContextMenuHolder, IBasePrintableProvider, IViewHolder, ISeparatorsHolder, ISupportBorderStyle
    {
        ...
        public SlackifyNestedFrameTemplate()
        {
            InitializeComponent();
