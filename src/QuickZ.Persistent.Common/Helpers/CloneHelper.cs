...
namespace QuickZ.Persistent.Common.Helpers {
    ...
    public class CloneHelper : IDisposable {
        ...
        /// <summary>
        /// Clones the object source.
        /// </summary>
        /// <typeparam name="T"></typeparam>/// <param name="synchronize">If set to true, reference properties are only cloned in case
        ...
        /// <returns>Cloned object from source.</returns>
